  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="p-1.5 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-all focus:outline-none"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 overflow-hidden text-slate-900 dark:text-slate-100 transition-all animate-in fade-in zoom-in-95 duration-150">
          <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
            ...
            {recentlyViewed.length > 0 && (
              <button
                ...
                className="text-[11px] text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 transition-colors flex items-center gap-1"
                title="Clear history"
              >
          ...
          <div className="p-1.5 divide-y divide-slate-100 dark:divide-slate-800/60 max-h-72 overflow-y-auto">
            {recentlyViewed.length === 0 ? (
              ...
              recentlyViewed.map((item) => (
                <div
                  ...
                  className="group flex items-center justify-between p-2.5 rounded-xl cursor-pointer hover:bg-slate-100/80 dark:hover:bg-slate-800/70 transition-all"
                >
