  ...
  const renderOtherInput = (
    ...
    return (
      <input
        ...
        className="mt-1 ml-6 w-full max-w-xs rounded border border-steel-200 dark:border-steel-700 bg-white dark:bg-steel-900 px-2 py-1 text-xs text-steel-900 dark:text-steel-100 placeholder-steel-400 focus:outline-none focus:border-primary-500"
      />
    );
  };
              ...
              return (
                <div key={j}>
                  ...
                  >
                    ...
                    />
                    <span
                      className={`text-sm ${isSelected ? 'text-gray-800 dark:text-steel-100 font-medium' : 'text-gray-800 dark:text-steel-100'}`}
                      dangerouslySetInnerHTML={{ __html: renderInlineMarkdown(label) }}
                    />
                  </label>
