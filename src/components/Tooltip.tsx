...
export const Tooltip: React.FC<TooltipProps> = ({
  ...
  return (
    ...
    >
      ...
      {showIcon && (
        <Info className="w-3.5 h-3.5 ml-1 text-slate-400 group-hover/tooltip:text-indigo-500 dark:group-hover/tooltip:text-indigo-400 cursor-help transition-colors flex-shrink-0" />
      )}
      ...
      >
        <div className="bg-slate-900 dark:bg-slate-800 text-slate-100 text-[11px] font-sans font-medium px-3 py-1.5 rounded-lg shadow-xl border border-slate-700/80 max-w-xs whitespace-normal leading-snug text-center">
          {content}
