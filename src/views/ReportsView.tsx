...
export const ReportsView: React.FC = () => {
 ...
 <Link to={`/agent-records/${rep.id}`} className="font-mono text-[11px] text-indigo-600 hover:underline">{rep.id}</Link>
 </div>

 <h2 className="text-base font-bold text-slate-900 font-poppins">{rep.title}</h2>
