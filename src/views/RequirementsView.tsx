                ...
                <tr key={req.id} className="hover:bg-slate-700/30 transition-colors">
                  <td className="py-3 px-4">
                    <div className="flex flex-col">
                      <Link to={`/requirements/${req.id}`} className="font-bold text-white hover:text-indigo-300 transition-colors">
                        {req.title || 'Untitled Requirement'}
                      </Link>
                      <span className="font-mono text-[10px] text-slate-400">{req.id}</span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-slate-300 font-mono text-[11px] uppercase">{req.reqType || 'FUNCTIONAL'}</td>
                  <td className="py-3 px-4">
